...
const PageLayout: React.FC<IProps> = ({ children }) => {
  ...
  return (
    <Space className="layout" direction="vertical" style={{ width: '100%' }} size={[0, 48]}>
      <Layout>
        <Header className={'px-5 flex  justify-between  fixed z-50 '}>
        ...
        <Layout>
          <div className=" flex items-start justify-start mt-[60px]">
            ...
            <div style={{ flex: 1, overflow: 'auto', height: 'calc(100vh - 66px)' }}>
